...
function Contato() {
  ...
  const redesVisiveis = contato
    ? [
      ...
      contato.email_adocao && {
        key: "email_adocao",
        label: "Adoção",
        href: `mailto:${contato.email_adocao}`,
        Icon: IconEmail,
        cor: "email",
        valor: contato.email_adocao,
      },

      contato.email_financeiro && {
        key: "email_financeiro",
        label: "Financeiro",
        href: `mailto:${contato.email_financeiro}`,
        Icon: IconEmail,
        cor: "email",
        valor: contato.email_financeiro,
      },
    ].filter(Boolean)
    : [];
        ...
        {contato && editando && (
          <form className="contato-form" onSubmit={handleSalvar}>
            ...
            <div className="contato-form-group">
              ...
              <label className="contato-form-field">
                <span>E-mail Adoção</span>
                <input
                  name="email_adocao"
                  type="email"
                  value={form.email_adocao || ""}
                  onChange={handleChange}
                  placeholder="adocao@acapra.org.br"
                />
              </label>
              ...
              <label className="contato-form-field">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="financeiro@acapra.org.br"
                />
              </label>
            </div>
